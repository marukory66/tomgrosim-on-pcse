...
#%%
from root_dynamics import Simple_Root_Dynamics 
#%%
...
#%%
Simple_Root_Dynamics = Simple_Root_Dynamics(day=date(2007,7,3), kiosk=kiosk,parameters = parvalues)
Simple_Root_Dynamics.calc_rates(day=date(2007,7,3), drv=drv,kiosk=kiosk)
